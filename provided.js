...
let matchAudio1 = new Audio('audio/match-1.wav');
let matchAudio2 = new Audio('audio/match-2.wav');
let matchAudio3 = new Audio('audio/match-3.wav');
let matchAudio4 = new Audio('audio/match-4.wav');
let matchAudio5 = new Audio('audio/match-5.wav');
let mismatchAudio1 = new Audio('audio/mismatch-1.wav');
let mismatchAudio2 = new Audio('audio/mismatch-2.wav');
let mismatchAudio3 = new Audio('audio/mismatch-3.wav');
let mismatchAudio4 = new Audio('audio/mismatch-4.wav');
let mismatchAudio5 = new Audio('audio/mismatch-5.wav');
let winAudio = new Audio('audio/win.wav');
let streak1 = new Audio('audio/streak-1.wav')
let streak2 = new Audio('audio/streak-2.wav')
